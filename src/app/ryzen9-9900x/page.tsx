    ...
    <main className='bg-black text-white flex flex-col items-center md:items-start h-full min-h-screen'>
      ...
      <div className='px-4 md:px-48 py-12 flex flex-col lg:flex-row gap-8'>
        ...
        <div className='flex flex-col gap-4 justify-center md:justify-start'>
          <div className='text-2xl font-bold'>AMD Ryzen 9 9900X</div>
          <div className='text-lg'>AM5, 12 x 4.4 ГГц, L2 - 12 МБ, L3 - 64 МБ, 2 х DDR5-5600 МГц, AMD Radeon Graphics, TDP 120 Вт</div>
          <div className='w-full flex gap-6 items-center justify-center md:justify-end'>
            ...
            <div onClick={() => window.open("/pay?price=" + price + "&item=9900x", "_self")} className='bg-green-700 hover:bg-green-600 cursor-pointer select-none rounded-2xl px-12 py-4 w-fit'>КУПИТЬ</div>
          </div>
        </div>
      </div>
      <div className='px-4 md:px-48 py-12 flex flex-col gap-4'>
        ...
        <div className='flex flex-col md:w-2/3'>
          ...
          <div className='grid grid-cols-2 gap-4 bg-stone-800'>
            ...
            <div className='p-2'>960КБ</div>
          </div>
          <div className='grid grid-cols-2 gap-4 bg-stone-800'>
            <div className='bg-stone-900 p-2'>Кэш L2</div>
            <div className='p-2'>12МБ</div>
          </div>
          <div className='grid grid-cols-2 gap-4 bg-stone-800'>
