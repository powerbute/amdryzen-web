    ...
    <main className='bg-black text-white flex flex-col items-center md:items-start h-full min-h-screen'>
      ...
      <div className='px-4 md:px-48 py-12 flex flex-col lg:flex-row gap-8'>
        ...
        <div className='flex flex-col gap-4 justify-center md:justify-start'>
          <div className='text-2xl font-bold'>AMD Ryzen 5 9600X</div>
          <div className='text-lg'>AM5, 6 x 3.9 ГГц, L2 - 6 МБ, L3 - 32 МБ, 2 х DDR5-5600 МГц, AMD Radeon Graphics, TDP 65 Вт</div>
          <div className='w-full flex gap-6 items-center justify-center md:justify-end'>
            ...
            <div onClick={() => window.open("/pay?price=" + price + "&item=9600x", "_self")} className='bg-green-700 hover:bg-green-600 cursor-pointer select-none rounded-2xl px-12 py-4 w-fit'>КУПИТЬ</div>
          </div>
        </div>
      </div>
